...
class EvaluationPipeline:
    ...
    def evaluate_case_report(self, case_id: str):
        ...
        r1_system_prompt = (
            ...
            "1. Citation Depth & Integration: Does the report feature detailed, comprehensive citations integrated heavily throughout the discussion to back up specific clinical claims?\n"
            ...
            "ABSOLUTE RULE - FORMATTING & EXCLUSIONS: Ignore Markdown glitches, missing headers, or raw image filenames caused by XML conversion. Furthermore, completely ignore all administrative or non-clinical sections (e.g., Funding, Acknowledgements, Disclosures, Declarations, Ethics). Judge purely on the clinical substance, logical sequence, and granular textual integration.\n\n"
            "ABSOLUTE RULE - TIMELINE (2026): The current year is 2026. Do NOT penalize recent citations (2024-2026) or flag them as hallucinated simply because they exceed your internal training cutoff.\n\n"
